...
<script runat="server">
        ...
        private void GridView1_AddRowFill()
        {
            ...
            ((TextBox)GridView1.FooterRow.FindControl("CUPO")).Text = Convert.ToString(vSALA.CUPO);
            ((TextBox)GridView1.FooterRow.FindControl("NOMBRE")).Text = Convert.ToString(vSALA.NOMBRE);
            ((TextBox)GridView1.FooterRow.FindControl("UBICACION")).Text = Convert.ToString(vSALA.UBICACION);

        }
        private void GridView1_EditRowFill()
        {
            SALA vSALA = new SALA();
            vSALA.Fill(Convert.ToString(GridView1.DataKeys[GridView1.EditIndex].Values[0]));

            ((TextBox)GridView1.Rows[GridView1.EditIndex].FindControl("CUPO")).Text = Convert.ToString(vSALA.CUPO);
            ((TextBox)GridView1.Rows[GridView1.EditIndex].FindControl("NOMBRE")).Text = Convert.ToString(vSALA.NOMBRE);
            ((TextBox)GridView1.Rows[GridView1.EditIndex].FindControl("UBICACION")).Text = Convert.ToString(vSALA.UBICACION);
        ...
        private void GridView1_Insert()
        {
            try
            {
                ...
                vSALA.CUPO = Convert.ToString(((TextBox)GridView1.FooterRow.FindControl("CUPO")).Text.ToString());
                vSALA.NOMBRE = Convert.ToString(((TextBox)GridView1.FooterRow.FindControl("NOMBRE")).Text.ToString());
                vSALA.UBICACION = Convert.ToString(((TextBox)GridView1.FooterRow.FindControl("UBICACION")).Text.ToString());
        ...
        private void GridView1_Update()
        {
            try
            {
                ...
                vSALA.ID = Convert.ToString(GridView1.DataKeys[GridView1.EditIndex].Values[0]);
                vSALA.CUPO = Convert.ToString(((TextBox)GridView1.Rows[GridView1.EditIndex].FindControl("CUPO")).Text.ToString());
                vSALA.NOMBRE = Convert.ToString(((TextBox)GridView1.Rows[GridView1.EditIndex].FindControl("NOMBRE")).Text.ToString());
                vSALA.UBICACION = Convert.ToString(((TextBox)GridView1.Rows[GridView1.EditIndex].FindControl("UBICACION")).Text.ToString());
...
<table width="100%"><tr><td align="center" Width="100%">
        ...
        <table width="90%"><tr><td><h3>SALA</h3></td></tr><tr><td>
        ...
        <Columns>
            ...
            <asp:TemplateField>
             ...
             <asp:TemplateField HeaderText="CUPO" SortExpression="CUPO">
                ...
                <EditItemTemplate>
                    <asp:TextBox ID="CUPO" Text='<%# Eval("CUPO") %>' runat="server" Width="100%"/>
                </EditItemTemplate>
                <FooterTemplate>
                    <asp:TextBox ID="CUPO" Text='' runat="server" Width="100%"/>        
                </FooterTemplate>
            </asp:TemplateField>          
             ...
             <asp:TemplateField HeaderText="NOMBRE" SortExpression="NOMBRE">
                ...
                <FooterTemplate>
                    <asp:TextBox ID="NOMBRE" Text='' runat="server" Width="100%"/>        
                </FooterTemplate>
            </asp:TemplateField>          
            
                         <asp:TemplateField HeaderText="UBICACION" SortExpression="UBICACION">
                <ItemTemplate><%# Eval("UBICACION")%></ItemTemplate>
                <EditItemTemplate>
                    <asp:TextBox ID="UBICACION" Text='<%# Eval("UBICACION") %>' runat="server" Width="100%"/>
                </EditItemTemplate>
                <FooterTemplate>
                    <asp:TextBox ID="UBICACION" Text='' runat="server" Width="100%"/>        
                </FooterTemplate>
            </asp:TemplateField>                                                                          
		</Columns>
