...
public class EVENTOSALA
{
    ...
    public void Create()
    {
        string vSql = "INSERT INTO eventosala (EVENTOID, SALAID) VALUES(@EVENTOID, @SALAID)";
    ...
    {
        string vSql = "DELETE FROM eventosala WHERE ID = @ID" ;
    ...
    {
        DataTable dt = sqlserver.Get("SELECT * FROM eventosala WHERE ID =" + pID);
        if (dt.Rows.Count > 0)
        {
    ...
    {
        return sqlserver.Get("SELECT * FROM eventosala ");
    }
